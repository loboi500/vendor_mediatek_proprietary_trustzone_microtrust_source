...
#define KEYMASTER_MAX_BUFFER_LENGTH (1024 * 140)
...
enum keymaster_command : uint32_t {
    ...
    KM_DEVICE_LOCKED                = (26 << KEYMASTER_REQ_SHIFT),
    KM_EARLY_BOOT_ENDED             = (27 << KEYMASTER_REQ_SHIFT),
    KM_GENERATE_RKP_KEY             = (29 << KEYMASTER_REQ_SHIFT),
    KM_GENERATE_CSR                 = (30 << KEYMASTER_REQ_SHIFT),
    KM_GENERATE_TIMESTAMPTOKEN      = (31 << KEYMASTER_REQ_SHIFT),
