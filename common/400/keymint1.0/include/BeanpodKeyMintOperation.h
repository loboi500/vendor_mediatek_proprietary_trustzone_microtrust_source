...
class BeanpodKeyMintOperation : public BnKeyMintOperation {
public:
	explicit BeanpodKeyMintOperation(const shared_ptr<BeanpodKeymaster> implementation,
					keymaster_operation_handle_t opHandle);
	virtual ~BeanpodKeyMintOperation();
...
protected:
	std::shared_ptr<::keymaster::BeanpodKeymaster> impl_;
