...
#ifndef HIDL_android_hardware_keymaster_V4_1_BeanpodKeymaster4Device_H_
#define HIDL_android_hardware_keymaster_V4_1_BeanpodKeymaster4Device_H_
...
class BeanpodKeymaster41Device : public IKeymasterDevice, public V4_0::ng::BeanpodKeymaster4Device {
	using super = V4_0::ng::BeanpodKeymaster4Device;
public:
	explicit BeanpodKeymaster41Device(BeanpodKeymaster* impl) : super(impl) {}
	virtual ~BeanpodKeymaster41Device();
	...
	Return<ErrorCode> destroyAttestationIds() override {
		return super::destroyAttestationIds();
	}
	...
	using ::android::hardware::keymaster::V4_1::IKeymasterDevice::registerAsService;
};
...
#endif  // HIDL_android_hardware_keymaster_V4_1_BeanpodKeymaster4Device_H_
