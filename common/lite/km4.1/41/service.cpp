...
int main() {
	...
	if (err != 0) {
		LOG(FATAL) << "Could not initialize BeanpodKeymaster41 (" << err << ")";
		return -1;
	}

	auto keymaster = new ::keymaster::V4_1::BeanpodKeymaster41Device(bpKeymaster);
	...
	LOG(INFO) << "register beanpod keymaster4.1 success";
