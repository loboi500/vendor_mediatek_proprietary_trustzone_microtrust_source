                       ...
                       const void *r, size_t req_len)
{
    ...
    (void)property_set("vendor.soter.teei.init", "INIT_OK");
                       ...
                       const void *r, size_t req_len)
{
    ...
    (void)property_set("vendor.soter.teei.persist", "INIT_OK");
                       ...
                       const void *r, size_t req_len)
{
    ...
    (void)property_set("vendor.soter.teei.proinfo", "INIT_OK");
